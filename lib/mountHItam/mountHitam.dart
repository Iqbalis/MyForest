...
class mountHitam extends StatefulWidget {
  @override
  _HitamPageState createState() => _HitamPageState();
}

class _HitamPageState extends State<mountHitam> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text('13,2 km', style: TextStyle(fontSize: 24,
                  fontWeight: FontWeight.bold,
                  color: Colors.white)),
              SizedBox(width: 10),
              Text('Trail length',
      ...
      children: [
        StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              ...
              .where('mountName', isEqualTo: 'Mount Hitam')
                    ...
                    if (user != null) {
                      try {
                        await FirebaseFirestore.instance.collection('review').add({
                          'mountName': 'Mount Hitam',  // Set mount name
