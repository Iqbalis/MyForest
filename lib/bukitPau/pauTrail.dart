...
class PauTrail extends StatefulWidget {
  @override
  _PauTrailScreen createState() => new _PauTrailScreen();
}

class _PauTrailScreen extends State<PauTrail> {
  ...
  Future<void> _loadGPXRoute() async {
    try {
      ...
      await rootBundle.loadString('assets/gpxFile/pau.xml');
