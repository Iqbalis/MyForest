...
class HitamTrail extends StatefulWidget {
  const HitamTrail({Key? key}) : super(key: key);

  @override
  _HitamTrailScreen createState() => _HitamTrailScreen();
}
...
class _HitamTrailScreen extends State<HitamTrail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hitam Trail Map'),
      ),
      body: Stack(
        children: [
          _gpxRoute.isEmpty
            ...
            options: MapOptions(
              initialCenter: _calculateRouteCenter(_gpxRoute), // Center on the Hitam trail initially
              initialZoom: 13,
            ),
            children: [
              TileLayer(
