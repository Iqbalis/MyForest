...
class LagongTrail extends StatefulWidget {
  @override
  _LagongTrailScreen createState() => new _LagongTrailScreen();
}

class _LagongTrailScreen extends State<LagongTrail> {
  ...
  Future<void> _loadGPXRoute() async {
    try {
      ...
      await rootBundle.loadString('assets/gpxFile/lagong.xml');
